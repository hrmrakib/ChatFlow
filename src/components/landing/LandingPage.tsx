    ...
    <div id="landing-page-root" className="min-h-full bg-[#030712] text-slate-100 overflow-y-auto selection:bg-cyan-500/30">
      ...
      <section className="relative z-10 pt-20 pb-28 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="mt-12">
          <button
            onClick={onEnterChat}
            className="group relative px-8 py-4 bg-white text-black font-extrabold rounded-2xl text-lg shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.5)] flex items-center space-x-3 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
